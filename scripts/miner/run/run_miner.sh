...
export POKER44_V1_VARIANT="${POKER44_V1_VARIANT:-v1_custom}"
export POKER44_MAX_BOT_FRACTION="${POKER44_MAX_BOT_FRACTION:-0.22}"
export POKER44_SAVE_RAW_CHUNKS="${POKER44_SAVE_RAW_CHUNKS:-0}"
export POKER44_MODEL_NAME="${POKER44_MODEL_NAME:-poker44-v1-custom}"
export POKER44_MODEL_VERSION="${POKER44_MODEL_VERSION:-1}"
export POKER44_MODEL_REPO_URL="${POKER44_MODEL_REPO_URL:-https://github.com/browndev7777-alt/PokerV4}"
